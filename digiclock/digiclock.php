...
for ($i = 0; $i < $day; $i++) {
    ...
    $weather['forecast'][$i]['day_windspeed']      = (int)$xml->forecast->day[$i]->daytime->windspeed;
    $weather['forecast'][$i]['day_winddirection']      = (string)$xml->forecast->day[$i]->daytime->winddirection;
}
